...
function activate(context) {
    ...
    // Register the provider for the 'extPoc.counter' view.
    // Use webview activation.
    context.subscriptions.push(vscode.window.registerWebviewViewProvider(FlutterWebviewProvider.viewType, provider));
...
FlutterWebviewProvider.viewType = 'extPoc.counter';
function deactivate() { }
